...
namespace GomezcoelloCristian_PruebaProgreso1.Controllers
{
    public class CelularController : Controller
    {
        ...
        public CelularController(GomezcoelloCristian_PruebaProgreso1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Modelo,Ano,Precio")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Modelo,Ano,Precio")] Celular celular)
        {
            if (id != celular.Id)
            {
                return NotFound();
